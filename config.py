...
class Paths:
    ...
    # directory in which policies get saved each adversarial step for evaluation purposes
    policies: str

    # dump log for ghostscript and pdflatex
    dump: str
...
DEFAULT_GENERAL = AppConfig(
    ...
    num_real_samples=2000,  # 5000 TODO 1000
    ...
    batch_size=multiprocessing.cpu_count(),  # computational cost reasons TODO kleinere batchsize?
